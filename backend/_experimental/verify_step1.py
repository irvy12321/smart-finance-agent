...
def test_imports():
    ...
    for module_path, imports in modules:
        try:
            __import__(module_path, fromlist=imports.split(", "))
...
def test_initialization():
    ...
    try:
        ...
        print("\n1. 测试 ToolRegistry...")
        ToolRegistry()
        print("   [OK] ToolRegistry 初始化成功")

        # 测试 PlannerAgent
        print("\n2. 测试 PlannerAgent...")
        PlannerAgent()
        print("   [OK] PlannerAgent 初始化成功")

        # 测试 ExecutorAgent
        print("\n3. 测试 ExecutorAgent...")
        ExecutorAgent()
        print("   [OK] ExecutorAgent 初始化成功")

        # 测试 Reasoner
        print("\n4. 测试 Reasoner...")
        Reasoner()
        print("   [OK] Reasoner 初始化成功")

        # 测试 Orchestrator
        print("\n5. 测试 Orchestrator...")
        Orchestrator(use_router=False)
...
def test_data_structures():
    ...
    try:
        ...
        from app.core.reasoner import ChartSpec, ReasoningResult
