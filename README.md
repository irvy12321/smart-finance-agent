...
**项目规模**：后端 15k+ / 前端 10k+ 行，51 个 REST 接口，342 项测试通过（后端 287 passed / 2 skipped，前端 55 passed，CI 全绿）；注册 10 个取数 / 分析工具，覆盖行情、财务、新闻、知识库（RAG）、网页爬虫 5 类数据源。
