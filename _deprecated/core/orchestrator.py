...
from core.executor import ExecutorAgent, ExecutionResult
from core.reasoner import Reasoner, ReasoningResult
from core.report_agent import ReportAgent, ResearchReport
from core.chart_renderer import ChartRenderer
from core.fallback_manager import FallbackManager
from core.agent_status import EventBus, AgentEvent, AgentStage, TaskStateTracker
from core.observability.metrics import MetricsCollector, record_task_result, get_metrics_summary
...
from utils.tracing import TraceContext, PipelineTracker
    ...
    async def run(self, query: str) -> RunResult:
        ...
        with trace.span("synthesizer"):
            ...
            try:
                ...
                from core.report_agent import StructuredAnalysis
